...
Use `.env.example` only for the OpenAI API key placeholder and
deployment-specific connection URLs. Prompt files, model behavior, routing
settings, budgets, and artifact paths belong in committed non-secret
